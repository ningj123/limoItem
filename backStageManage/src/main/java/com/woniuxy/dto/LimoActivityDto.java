...
/**
 * @ClassName LimoActivityDto
 * @Author shadow
 * @Date 2020/11/13 14:24
 * @Description TODO
 **/
public class LimoActivityDto implements Serializable {
    ...
    public LimoActivityDto() {
    }

    public LimoActivityDto(Integer aId, String aName, Integer aInven, String aImages, String aDes, Double aPrice, Integer aType, Integer aSellNum, LocalDateTime aSellTime, LocalDateTime aStartTime, LocalDateTime aEndTime, Integer cId, Integer aStatus, String aCity) {
        this.aId = aId;
        this.aName = aName;
        this.aInven = aInven;
